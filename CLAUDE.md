...
| `medharness` | The **process** around it: AI CR workflow, CI gates, scaffolding, approval, and all traceability analysis over the item set | `approval` · `automation` · `change` · `context` · `doctor` · `evidence` · `init` · `release` · `soup-sync` · `upgrade` · `verify` |
