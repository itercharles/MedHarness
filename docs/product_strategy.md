...
See [`docs/product_roadmap.md`](product_roadmap.md) for milestone grouping, exit criteria, and CR tracking. CRs are the authoritative backlog — full CR descriptions live in `compliantflow-dhf/DHF/items/09_cr/`.
