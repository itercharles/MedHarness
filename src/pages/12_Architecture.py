"""Architecture Specification page - uses universal template."""
...
st.set_page_config(
    page_title="Architecture Specifications",
    page_icon="🏗️",
    layout="wide"
)
...
if doc_type:
    ...
    st.error("ARCH doc type not found in project configuration")
