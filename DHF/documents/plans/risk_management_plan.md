...
This risk management plan covers the CompliantFlow software system across its full lifecycle: development, release, post-market maintenance, and retirement. Lifecycle phases in scope: design, implementation, verification, validation, release, and post-production.
...
**Intended use:** CompliantFlow is used by medical device software development teams to manage Design History Files, enforce IEC 62304 / ISO 14971 / IEC 82304-1 compliance, and generate audit evidence for regulatory submissions.

**Intended users:** Software engineers, quality engineers, regulatory affairs specialists.

**Reasonably foreseeable misuse:**
- Using compliance check output as a substitute for regulatory review without human oversight
- Relying on automated checks as the sole verification of IEC 62304 §6.1 completeness
- Operating without understanding the limitations of LLM-based semantic checks
