...
def cr_closure_gate(
    ...
    Checks:
    1. All ``proposed_new_items`` from the CR item exist in the DHF.
    ...
    raw = cr_item.get("proposed_new_items") or []
    ...
    if not proposed:
        return {
            ...
            "summary": f"CR {cr_id} — no proposed_new_items recorded; closure check skipped.",
        }
    ...
    verify_result = validate_verification_completeness(
        ...
        req_types=tuple(types_to_check),
