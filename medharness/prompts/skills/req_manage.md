...
SWDD items need to be created or updated, and document them in the spec — do not
create or edit items. During design, create or update those items with correct
traceability.
