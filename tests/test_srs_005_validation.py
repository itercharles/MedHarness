...
class TestDataValidation:
    ...
    def test_type_checking_on_load(self):
        ...
        for item in items[:10]:  # Check first 10
            assert isinstance(item, Item), f"Loaded item must be Item instance"
    ...
    def test_all_items_validate_successfully(self):
    ...
    def test_invalid_yaml_rejected(self):
        ...
        temp_file = SPECS_DIR / "00_uc" / "INVALID-TEST.yaml"
